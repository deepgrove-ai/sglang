...
@triton.jit
def qk_norm_and_no_rope_forward_kernel(qkv_ptr,
...
@triton.jit
def compatible_qk_norm_and_no_rop_forward_kernel(qkv_ptr,
                                                   q_norm_weight_ptr,
                                                   k_norm_weight_ptr,
                                                   freqs_ptr,
                                                   qo_ptr, ko_ptr, vo_ptr,
...
def triton_qk_norm_and_split_forward(qkv, q_norm_weight, k_norm_weight,
    ...
    if H_p == H and h_p == h:
        qk_norm_and_no_rope_forward_kernel[grid](
            qkv,
        ...
        compatible_qk_norm_and_no_rop_forward_kernel[grid](
            qkv,
            q_norm_weight, k_norm_weight,
            freqs,
            qo, ko, vo,
...
@triton.jit
def qk_norm_and_no_rope_backward_kernel(gq_ptr, gk_ptr, gv_ptr,
                                          qkv_ptr,
                                          q_norm_weight_ptr,
                                          k_norm_weight_ptr,
                                          freqs_ptr,
...
@triton.jit
def compatible_qk_norm_and_no_rope_backward_kernel(gq_ptr, gk_ptr, gv_ptr,
                                                     qkv_ptr,
                                                     q_norm_weight_ptr,
                                                     k_norm_weight_ptr,
                                                     freqs_ptr,
...
def triton_qk_norm_and_split_backward(gq, gk, gv, qkv, q_norm_weight,
    ...
    grid = (L,)
    if H == H_p and h == h_p:
        qk_norm_and_no_rope_backward_kernel[grid](
            gq,
            gk,
            gv,
            qkv,
        ...
        compatible_qk_norm_and_no_rope_backward_kernel[grid](
            gq, gk, gv,
            qkv,
            q_norm_weight, k_norm_weight,
            freqs,
